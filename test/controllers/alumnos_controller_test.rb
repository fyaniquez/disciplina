...
class AlumnosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create alumno" do
    assert_difference('Alumno.count') do
      post alumnos_url, params: { alumno: { ci: @alumno.ci, nombre: @alumno.nombre, rude: @alumno.rude } }
    end
  ...
  test "should update alumno" do
    patch alumno_url(@alumno), params: { alumno: { ci: @alumno.ci, nombre: @alumno.nombre, rude: @alumno.rude } }
