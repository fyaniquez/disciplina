...
class SancionesControllerTest < ActionDispatch::IntegrationTest
  setup do
    @sancion = sanciones(:one)
  end
  ...
  test "should create sancion" do
    assert_difference('Sancion.count') do
      post sanciones_url, params: { sancion: { descripcion: @sancion.descripcion, estado: @sancion.estado, nombre: @sancion.nombre, norma: @sancion.norma, posicion: @sancion.posicion } }
    end
  ...
  test "should destroy sancion" do
    ...
    assert_redirected_to sanciones_url
  end
end
