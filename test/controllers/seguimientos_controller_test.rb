...
class SeguimientosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create seguimiento" do
    assert_difference('Seguimiento.count') do
      post seguimientos_url, params: { seguimiento: { caso_id: @seguimiento.caso_id, fecha: @seguimiento.fecha, glosa: @seguimiento.glosa, numero: @seguimiento.numero } }
    end
  ...
  test "should update seguimiento" do
    patch seguimiento_url(@seguimiento), params: { seguimiento: { caso_id: @seguimiento.caso_id, fecha: @seguimiento.fecha, glosa: @seguimiento.glosa, numero: @seguimiento.numero } }
